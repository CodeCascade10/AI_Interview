...
const Login = () => {
  ...
  return (
    <main className="min-h-screen flex items-center justify-center bg-[#0A0F1C] px-6 relative overflow-hidden font-sans">
      
      {/* Background Glow */}
      <div className="absolute inset-0 pointer-events-none flex justify-center items-center">
        <div className="w-[40%] h-[40%] bg-blue-600/10 blur-[120px] rounded-full"></div>
      </div>
      ...
      <div className="w-full max-w-md bg-slate-900/40 backdrop-blur-xl border border-slate-700/50 rounded-[2.5rem] shadow-2xl p-10 md:p-12 relative z-10">
        ...
        <div className="text-center mb-10 mt-4">
          ...
          <p className="text-slate-400 text-sm font-light">Sign in to continue your preparation</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button 
            type="submit" 
            className="w-full bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-white font-semibold py-4 rounded-2xl transition-all shadow-xl shadow-blue-500/20 active:scale-[0.98] mt-4"
          >
            Sign In
          </button>
        </form>
